...
class StructuralDesignAgent(BaseAgent):
    ...
    def __init__(self, session_id: str, meta: Dict[str, Any]):
        ...
        self.steel_sections = {
            ...
            'IPE600': {'h': 600, 'b': 220, 'tw': 12.0, 'tf': 19.0, 'A': 156.0, 'Ix': 92080, 'Wx': 3069},
            'HEA200': {'h': 190, 'b': 200, 'tw': 6.5, 'tf': 10.0, 'A': 53.8, 'Ix': 3692, 'Wx': 389},
            'HEA300': {'h': 290, 'b': 300, 'tw': 8.5, 'tf': 14.0, 'A': 112.5, 'Ix': 18260, 'Wx': 1260},
            'HEA400': {'h': 390, 'b': 300, 'tw': 11.0, 'tf': 19.0, 'A': 159.0, 'Ix': 45070, 'Wx': 2311},
            'HEA500': {'h': 490, 'b': 300, 'tw': 12.0, 'tf': 23.0, 'A': 197.8, 'Ix': 86970, 'Wx': 3550}
        }
